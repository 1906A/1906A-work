...
| 刘世辉 | 完成spring AMQP的代码实现完成                  | 完成         | 暂无                |                                          |

# day04 -6.10

| 姓名   | 笔记完成内容             | 录音完成内容 | 遇到的问题                      | 地址                                     |
| ------ | ------------------------ | ------------ | ------------------------------- | ---------------------------------------- |
| 于子宁 | 商品数据同步到es库       | 完成         | 无                              | https://github.com/1906A/YuZiNing        |
| 祝继蒙 | 商品数据同步到es库       | 完成         | 无                              | https://github.com/1906A/zhujimeng       |
...
| 姓名   | 笔记完成内容                      | 录音完成内容 | 遇到的问题        | 地址                                     |
| ------ | --------------------------------- | ------------ | ----------------- | ---------------------------------------- |
| 于子宁 | 订单的操作                        | 完成         | git提交代码有问题 | https://github.com/1906A/YuZiNing        |
| 祝继蒙 | 完成接入订单系统                  | 完成         | 暂无              | <https://github.com/1906A/zhujimeng      |
| 高子懿 | 商品列表展示                      | 未完成       | 暂无              | https://github.com/1906A/GaoZiYi.git     |
